              ...
              <div className="mb-6">
                ...
                <div className="relative mb-8">
                  <div className="text-left mb-6">
                    <h4 className="text-base font-semibold bg-blue-500 text-white px-3 py-1 inline-block">IC Track: Core PM skills to deep expertise</h4>
                  </div>
                ...
                <div className="relative">
                  <div className="text-left mb-4">
                    <h4 className="text-base font-semibold bg-green-500 text-white px-3 py-1 inline-block">Leadership Track: Team leadership and organizational strategy</h4>
                  </div>
