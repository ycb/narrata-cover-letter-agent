...
export function WorkHistoryDetailTabs({ selectedRole }: WorkHistoryDetailTabsProps) {
  ...
  return (
    <Tabs defaultValue="blurbs" className="h-full">
      <TabsList className="grid w-full grid-cols-2">
        <TabsTrigger value="blurbs">
      ...
      <TabsContent value="blurbs" className="h-full mt-4">
      ...
      <TabsContent value="links" className="h-full mt-4">
        <div className="space-y-4 h-full">
          <div className="flex items-center justify-between">
