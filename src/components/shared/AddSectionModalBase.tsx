                ...
                <div className="flex gap-3 mt-2">
                  ...
                  >
                    <div className="text-center">
                      ...
                      <div className={`text-sm ${selectedContentType === 'story' ? 'text-white/90' : 'text-muted-foreground'}`}>From your work history</div>
                    </div>
                  </Button>
                  <Button
                  ...
                  >
                    <div className="text-center">
                      ...
                      <div className={`text-sm ${selectedContentType === 'saved' ? 'text-white/90' : 'text-muted-foreground'}`}>Custom templates</div>
                    </div>
                  </Button>
                </div>
              </div>
                  ...
                  <div className="flex gap-3 mt-2">
                    ...
                    >
                      <div className="text-center">
                        ...
                        <span className={`text-sm block ${contentMethod === 'dynamic' ? 'text-white/90' : 'text-muted-foreground'}`}>
                    ...
                    >
                      <div className="text-center">
                        ...
                        <span className={`text-sm block ${contentMethod === 'static' ? 'text-white/90' : 'text-muted-foreground'}`}>
