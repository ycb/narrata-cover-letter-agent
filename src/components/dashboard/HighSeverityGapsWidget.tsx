...
export function HighSeverityGapsWidget({ gapSummary, isLoading, onClick }: HighSeverityGapsWidgetProps) {
    ...
    return (
      <Card className="shadow-soft">
        <CardHeader className="pb-3">
          <CardTitle className="text-sm text-center">High</CardTitle>
        </CardHeader>
  ...
  return (
    <Card className="shadow-soft border-destructive/30 cursor-pointer hover:shadow-medium transition-shadow" onClick={onClick}>
      <CardHeader className="pb-3">
