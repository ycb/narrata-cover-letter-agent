...
import { Users, AlertTriangle, Target, Circle, ChevronRight, ArrowRight } from 'lucide-react';
  ...
  if (isLoading) {
    return (
      <Card className="shadow-soft">
        ...
        <CardContent>
          <div className="text-sm text-muted-foreground">Loading work history gaps...</div>
        </CardContent>
      </Card>
    );
  }
  ...
  if (items.length === 0) {
    return (
      <Card className="shadow-soft border-success/30">
        ...
        <CardContent>
          <div className="text-sm text-muted-foreground">No gaps in work history.</div>
        </CardContent>
      </Card>
    );
  }
      ...
      <CardContent className="space-y-4">
        ...
        {filteredItems.length > 10 && (
          <Button
            ...
            size="sm"
            className="w-full"
            onClick={() => navigate('/work-history?filter=gaps')}
          >
