...
CREATE INDEX idx_evaluation_runs_llm_call_type ON public.evaluation_runs(llm_call_type);
CREATE INDEX idx_evaluation_runs_prompt_name ON public.evaluation_runs(prompt_name);
CREATE INDEX idx_evaluation_runs_quality_score ON public.evaluation_runs(quality_score);
